...
/**
 * ARCHIM1 pin assignment (pins_ARCHIM1.h)
 *
 * The Archim1 board requires Arduino Archim addons installed.
 * Add the following URL to Arduino IDE's Additional Board Manager URLs:
 * https:
//raw.githubusercontent.com/ultimachine/ArduinoAddons/master/package_ultimachine_index.json
 ...
 * https:
//github.com/ultimachine/Archim/wiki/Archim-v2.0
 * https:
//github.com/ultimachine/Archim/wiki
 *
 */
...
// D20 PB12 (Header J20 20)
#define SERVO1_PIN          21   
// D21 PB13 (Header J20 19)
...
// (3.3 Volts * 100000 Ohms) / (100000 Ohms + 20000 Ohms) = 2.75 Volts (max vref)
#define DEFAULT_PWM_MOTOR_CURRENT  {1000, 1000, 1000 } //, 1000, 1000} 
//X Y Z E0 E1, 1000 = 1000mAh
...
// D66 PB15 (Header J20 15)
#endif
#ifndef FIL_RUNOUT2_PIN
  #define FIL_RUNOUT2_PIN   67   
// D67 PB16 (Header J20 16)
#endif
